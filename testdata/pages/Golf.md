...
This page is test material: it exists so the renderer has something with how an external renderer turns a fenced block into a picture to draw.

## What this page covers

Diagrams is one of eleven pages in this folder. Together they are merged into a single document by
one of the output modes, which is how page breaks between files are checked.

- A list item about how an external renderer turns a fenced block into a picture
