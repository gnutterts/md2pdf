...
This page is test material: it exists so the renderer has something with what this tool does not do, and why that is on purpose to draw.

## What this page covers

Limitations is one of eleven pages in this folder. Together they are merged into a single document by
one of the output modes, which is how page breaks between files are checked.

- A list item about what this tool does not do, and why that is on purpose
