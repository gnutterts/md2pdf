...
This page is test material: it exists so the renderer has something with accents, dashes and the arrows that get transliterated to draw.

## What this page covers

Characters is one of eleven pages in this folder. Together they are merged into a single document by
one of the output modes, which is how page breaks between files are checked.

- A list item about accents, dashes and the arrows that get transliterated
