...
This page is test material: it exists so the renderer has something with bullets, numbers and nesting, including items that wrap to draw.

## What this page covers

Lists is one of eleven pages in this folder. Together they are merged into a single document by
one of the output modes, which is how page breaks between files are checked.

- A list item about bullets, numbers and nesting, including items that wrap
