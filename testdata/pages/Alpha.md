...
This page is test material: it exists so the renderer has something with how a document travels from Markdown to a finished page to draw.

## What this page covers

Getting started is one of eleven pages in this folder. Together they are merged into a single document by
one of the output modes, which is how page breaks between files are checked.

- A list item about how a document travels from Markdown to a finished page
