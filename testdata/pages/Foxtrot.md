...
This page is test material: it exists so the renderer has something with columns, alignment and a header that repeats to draw.

## What this page covers

Tables is one of eleven pages in this folder. Together they are merged into a single document by
one of the output modes, which is how page breaks between files are checked.

- A list item about columns, alignment and a header that repeats
