...
This page is test material: it exists so the renderer has something with the six heading levels and how they shape a page to draw.

## What this page covers

Headings and structure is one of eleven pages in this folder. Together they are merged into a single document by
one of the output modes, which is how page breaks between files are checked.

- A list item about the six heading levels and how they shape a page
